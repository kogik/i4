!(function () {
    "use strict";
    var t = function (t) {
        (this.input = null), (this.inputDisplay = null), (this.slider = null), (this.sliderWidth = 0), (this.sliderLeft = 0), (this.pointerWidth = 0), (this.pointerR = null), (this.pointerL = null), (this.activePointer = null), (this.selected = null), (this.scale = null), (this.step = 0), (this.tipL = null), (this.tipR = null), (this.timeout = null), (this.valRange = !1), (this.values = { start: null, end: null }), (this.conf = { target: null, values: null, set: null, range: !1, width: null, scale: !0, labels: !0, tooltip: !0, step: null, disabled: !1, onChange: null }), (this.cls = { container: "rs-container", background: "rs-bg", selected: "rs-selected", pointer: "rs-pointer", scale: "rs-scale", noscale: "rs-noscale", tip: "rs-tooltip" });
    ...
    (t.prototype.init = function () {
        ...
        (t.prototype.setValues = function (t, i) {
            ...
            return (
                ...
                this.conf.range ? (this.conf.tooltip && ((this.tipL.innerHTML = this.conf.values[this.values.start]), (this.tipR.innerHTML = this.conf.values[this.values.end])), (this.input.value = this.conf.values[this.values.start] + "," + this.conf.values[this.values.end]), (this.pointerR.style.left = this.values.end * this.step - this.pointerWidth / 2 + "px")) : (this.conf.tooltip && (this.tipL.innerHTML = this.conf.values[this.values.end]), (this.input.value = this.conf.values[this.values.end])),
